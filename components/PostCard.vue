  ...
  <nuxt-link ref="card" :to="post._path" class="block max-w-full transition-all group">
    <div class="flex items-center">
      ...
      <div class="max-w-full">
        <h3 class="opacity-90 text-xl mb-3 group-hover:(sm:-mx-3 tracking-wide text-white font-bold) transition-all">
...
.group:hover {
  h3 {
    background: linear-gradient(45deg, rgba(#00D5FF, 1), rgba(#ffffff, 1));
